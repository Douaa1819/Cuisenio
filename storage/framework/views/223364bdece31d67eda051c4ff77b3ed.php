...
<body
    ...
    <div
        ...
        <h2 style="font-size: 20px; color: #333;"><?php echo e($recipeTitle); ?></h2>

        <p style="font-size: 16px; color: #666;"><?php echo e($recipeDescription); ?></p>
...
<?php /**PATH C:\laragon\www\Cuisenio\resources\views/emails/newsletter.blade.php ENDPATH**/ ?>