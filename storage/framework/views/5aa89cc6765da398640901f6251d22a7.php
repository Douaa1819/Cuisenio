                ...
                <article
                    ...
                    <div class="flex justify-between items-center">
                        ...
                        <div class="flex justify-center gap-3">
                            ...
                            <div onclick="openComment(this,'<?php echo e($content->id); ?>')" class="cursor-pointer">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24"
                                    height="24" color="#000000" fill="none">
...
<script>
    ...
    function addComment(button) {
        ...
        $.ajax({
            url: "<?php echo e(route('commentContent.store')); ?>",
    ...
    function showComment(id) {
        $.ajax({
            url: "<?php echo e(route('commentContent.show', '')); ?>" + '/' + id,
            method: 'GET',
            dataType: 'json',
                ...
                data.comments.forEach(function(comment) {
                    var commentHtml = `
                                    ...
                                    ${comment.user.profile_photo_url
                                          ...
                                          :`<img src="<?php echo e(asset('images/cheef.jpg')); ?>" alt="" class="h-8 w-8 object-fill rounded-full">`
