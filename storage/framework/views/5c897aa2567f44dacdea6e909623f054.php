...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.header','data' => ['page' => '']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['page' => '']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
                        ...
                        <div class="bg-white shadow-lg rounded-lg overflow-hidden relative">
                            <div class="absolute right-0 top-0 m-3">
                                <button id="dropdownButton<?php echo e($recipe->id); ?>" onclick="toggleDropdown(<?php echo e($recipe->id); ?>)"
                                    class="text-white hover:text-pink-300 rounded-full focus:outline-none focus:ring">
                                    <i class="fas fa-ellipsis-v"></i>
                                </button>
                                <div id="dropdown<?php echo e($recipe->id); ?>" class="hidden absolute right-0 mt-8 w-44 bg-white rounded-md shadow-lg z-10">
                                ...
                                <?php if($recipe->image): ?>
                                <img src="<?php echo e(Storage::url($recipe->image->url)); ?>" alt="Recipe Image" class="w-full h-56 object-cover">
                                <?php endif; ?>
                            <div class="p-4">
                                <h3 class="text-lg font-semibold text-gray-800"><?php echo e($recipe->title); ?></h3>
                                ...
                                <div class="flex items-center mt-4">
                                    ...
                                    <span class="ml-2 text-sm text-gray-500"><?php echo e($recipe->updated_at->format('M d, Y')); ?></span>
                                </div>
                            </div>
                        </div>
...
<?php /**PATH C:\laragon\www\Cuisenio\resources\views\user\ownRecipe.blade.php ENDPATH**/ ?>