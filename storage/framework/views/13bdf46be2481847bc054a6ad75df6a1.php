...
<?php endif; ?>
        ...
        <div id="crud-modal" tabindex="-1" aria-hidden="true"
            ...
            <div class="relative p-4 w-full max-h-full">
                <div class="relative bg-white w-8/12 mx-auto rounded-lg shadow dark:bg-gray-700">
                    ...
                    <!-- Modal body -->
                    <form class="p-4 md:p-5" method="POST" action="<?php echo e(route('blog.store')); ?>"enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
                        ...
                        <div class="flex items-center justify-center">
                            <button type="submit"
                                ...
                                <svg class="text-white me-1 -ms-1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="22"
                                    height="22" color="#000000" fill="none">
        ...
        <div class="grid gap-8 lg:grid-cols-2">
            ...
            <article
                ...
                <h2 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white"><a href="#"><?php echo e($content->title); ?></a></h2>
             ...
             <?php $__currentLoopData = $contents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $singleContent): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                 ...
                 <footer class="flex justify-between items-center mb-2">
                     ...
                     <p class="text-sm text-gray-600 dark:text-gray-400"><time pubdate
                         datetime="2022-02-08" title="February 8th, 2022"><?php echo e($comment->created_at->diffForHumans()); ?></time></p>
             </div>
                         ...
                         <ul class="py-1 text-sm text-gray-700 dark:text-gray-200"
                             ...
                             <li>
                                <button>
                                     ...
                                     <a onclick="deleteComment(<?php echo e($comment->id); ?>)" class="block py-2 px-4 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white text-red-500">Remove</a>
                                    </button>
                                 <?php endif; ?>
                             </li>
                         </ul>
...
<?php endif; ?><?php /**PATH C:\laragon\www\Cuisenio\resources\views\user\blog.blade.php ENDPATH**/ ?>