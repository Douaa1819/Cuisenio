...
<?php endif; ?>
                    ...
                    <div class="mt-6 bg-gray-100 p-4 rounded-lg shadow">
                        ...
                        <form class="space-y-4" method="post" action="<?php echo e(route('comment.store')); ?>">
                            <?php echo csrf_field(); ?>
                            <?php echo method_field('POST'); ?>
...
</script><?php /**PATH C:\laragon\www\Cuisenio\resources\views/user/readMore.blade.php ENDPATH**/ ?>