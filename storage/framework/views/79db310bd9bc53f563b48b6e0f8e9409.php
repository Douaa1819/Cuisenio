...
<?php endif; ?>
    ...
    <div class="max-w-4xl mx-auto p-8">
        <form action="<?php echo e(route('recipes.store')); ?>" method="POST" class="bg-white p-6 rounded-lg shadow-lg"enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
            ...
            <div class="flex justify-between items-center mb-6">
                ...
                <div>
                    ...
                    <a href="<?php echo e(route('user.index')); ?>" class="text-red-500 hover:text-red-600 mr-4">
            ...
            <div class="mb-4">
                <div class="mb-4">
                    ...
                    <div class="grid grid-cols-3 gap-4">
                        <?php $__currentLoopData = $ingrediants; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $ingredient): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div>
                                <input type="checkbox" id="ingredient<?php echo e($index); ?>" name="ingredients[]"
                                    value="<?php echo e($ingredient->id); ?>">
                                <label for="ingredient<?php echo e($index); ?>"><?php echo e($ingredient->name); ?></label>
                            </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
                </div>
...
<?php /**PATH C:\laragon\www\Cuisenio\resources\views\user\AddRecipes.blade.php ENDPATH**/ ?>