                ...
                @foreach ($themes as $theme)
                    @if ($theme->images->isNotEmpty())
                        @foreach ($theme->images as $image)
                            <a href=    class="flex flex-col items-center transition duration-300 ease-in-out hover:scale-110 group">
              ...
              @foreach ($ingrediant as $ingrediant)
                  @if ($ingrediant->images->isNotEmpty())
                      @foreach ($ingrediant->images as $image)
                          <a href="{{ route('ingrediants',  $ingrediant)}}" class="flex flex-col items-center transition duration-300 ease-in-out hover:scale-110 group">
