...
<div class="bg-gray-100">
    <div class="flex">
        ...
        <div class="w-2/5 text-whitew pl-32 py-4 h-auto">
        ...
        <div class="w-3/5 border border-gray-600 h-auto  border-t-0">
            ...
            <div class="flex">
                ...
                <div class="flex-1 px-4 py-2 m-2">
                    <a href="" class=" text-2xl font-medium rounded-full text-black hover:bg-blue-800 hover:text-red-300 float-right">
            ...
            <div class="flex">
                ...
                <div class="w-64 px-2">
                    ...
                    <div class="flex items-center">
                        <div class="flex-1 text-center px-1 py-1 m-2">
                            <a href="#" class="mt-1 group flex items-center text-red-300 px-2 py-2 text-base leading-6 font-medium rounded-full hover:bg-blue-800 hover:text-red-300">
                ...
                <div class="flex-1">
                    <button class="bg-red-300 mt-5 hover:bg-pink-200 text-black font-bold py-2 px-8 rounded-full mr-8 float-right">
                        Add
                      </button>
                </div>
            </div>
        ...
        <div class="pl-16">
            <p class="text-base width-auto font-medium text-black flex-shrink">
              ...
              I was wondering what I can do with <span class="text-red-300">#tailwindcss</span>, so just started building Twitter  UI using Tailwind and so far it looks so promising. I will post my code after completion.
              [07/100]
                ...
                <div class="w-full">
                    ...
                    <div class="flex items-center">
                        <div class="flex-1 text-center">
                            <a href="#" class="w-12 mt-1 group flex items-center text-gray-500 px-3 py-2 text-base leading-6 font-medium rounded-full hover:bg-blue-800 hover:text-red-300">
        ...
        <div class="max-w-sm rounded-lg overflow-hidden shadow-lg m-4 bg-white">
            <div class="p-4">
                ...
                <div class="mt-4 space-y-4">
                    <div class="flex items-center">
                        <img class="h-10 w-10 rounded-full" src="https://via.placeholder.com/40x40" alt="Trending Topic Image">
                        <div class="ml-3">
                ...
                <div class="mt-4 text-right">
                    <a href="#" class="text-blue-500 hover:text-blue-700 text-sm font-semibold">Show more</a>
                </div>
            </div>
        </div>
    </div>
