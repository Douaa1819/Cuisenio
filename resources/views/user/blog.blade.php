    ...
    <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
        ...
        <div id="crud-modal" tabindex="-1" aria-hidden="true"
            ...
            <div class="relative p-4 w-full max-h-full">
                <div class="relative bg-white w-8/12 mx-auto rounded-lg shadow dark:bg-gray-700">
                    ...
                    <!-- Modal body -->
                    <form class="p-4 md:p-5" method="POST" action="{{ route('blog.store')}}"enctype="multipart/form-data">
                        @csrf
        ...
        <div class="grid gap-8 lg:grid-cols-2">
            ...
            <article
                ...
                <h2 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white"><a href="#">{{ $content->title }}</a></h2>
             ...
             @foreach ($contents as $singleContent)
                 ...
                 <footer class="flex justify-between items-center mb-2">
                     ...
                     <p class="text-sm text-gray-600 dark:text-gray-400"><time pubdate
                         datetime="2022-02-08" title="February 8th, 2022">{{ $comment->created_at->diffForHumans() }}</time></p>
             </div>
                         ...
                         <ul class="py-1 text-sm text-gray-700 dark:text-gray-200"
                             ...
                             <li>
                                <button>
                                     ...
                                     <a onclick="deleteComment({{ $comment->id }})" class="block py-2 px-4 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white text-red-500">Remove</a>
                                    </button>
                                 @endif
                             </li>
                         </ul>
