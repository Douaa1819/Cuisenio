<x-dashboard>
            ...
            <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                ...
                <tbody id="IngrediantTable">
                    ...
                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-800 hover:bg-gray-50 dark:hover:bg-gray-600">
                        ...
                        <td class="py-6 px-6">
                            <button onclick="openModal()"   onclick="return confirm('Are you sure you want to update this Ingrediant?')" class="text-green-500 hover:text-orange-300">
    ...
    <div id="editeThemeModal" class="hidden fixed inset-0 z-10 overflow-auto bg-black bg-opacity-40">
        <div class="flex items-center justify-center min-h-screen">
            <div class="bg-white rounded-lg mx-auto p-5 relative max-w-lg w-full">
                <span class="absolute top-0 right-0 m-3 cursor-pointer text-gray-400 hover:text-gray-600" onclick="closeModal()">&times;</span>
...
<script>
    ...
    function openModal() {
        document.getElementById('editeThemeModal').classList.remove('hidden');
    }

    function closeModal() {
        document.getElementById('editeThemeModal').classList.add('hidden');
    }
