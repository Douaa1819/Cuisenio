            ...
            <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                ...
                <tbody id="IngrediantTable">
                    ...
                    <tr
                        ...
                        <td class="py-6 px-6">
                            <button onclick="openModal(true, 'Sample Ingrediant')"
    ...
    <div id="addIngrediantModal" class="hidden fixed inset-0 z-10 overflow-auto bg-black bg-opacity-40">
        <div class="flex items-center justify-center min-h-screen">
            <div class="bg-white rounded-lg mx-auto p-5 relative max-w-lg w-full">
                ...
                <input type="text" id="newIngrediantName" placeholder="Ingrediant name..."
                    class="mb-4 w-full p-2 border rounded">
                <button class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded"
                    onclick="addOrUpdateIngrediant()">Save Ingrediant</button>
            </div>
        </div>
    </div>
</x-dashboard>
