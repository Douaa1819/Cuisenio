...
<body class="bg-gray-100 dark:bg-gray-800">
    <header class="flex items-center justify-between w-full h-16 bg-red-300 text-gray-600 dark:text-gray-300 px-6 shadow-lg fixed top-0 left-0 right-0 z-50">
        ...
        <!-- Profile Dropdown -->
        <div class="relative">
            <button id="profileDropdown" class="flex items-center space-x-2 bg-red-300 rounded-full p-1 hover:bg-pink-200 focus:outline-none">
            ...
            <div id="dropdownContent" class="hidden absolute right-0 mt-2 py-2 w-48 bg-white rounded-md shadow-xl z-20">
                <a href="{{ route ('user.profile') }}" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100"> Edit Profile</a>
    ...
    <aside id="sidebar" class="hidden lg:fixed lg:z-30 lg:left-0 lg:top-0 lg:block shadow-lg w-80  h-screen bg-white dark:bg-gray-900 py-4 px-6">
        <div class="mb-8">
        ...
        <nav class="mt-10">
            ...
            <a href="{{ route('user')}}" class="flex items-center mt-4 py-2 px-6 text-gray-600 dark:text-gray-400 hover:bg-gray-200 dark:hover:bg-gray-700 rounded-md transition-colors duration-200">
