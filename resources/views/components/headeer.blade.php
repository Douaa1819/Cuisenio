...
<div class="flex gap-5 justify-around items-start px-2 py-1 text-sm font-bold bg-white text-stone-300 shadow-xlg">
    ...
    <div class="flex my-auto items-center justify-center gap-5">
        <a href="{{ route('login')}}"
            ...
            <span
                class="absolute inset-0 w-full h-full duration-300 delay-300 bg-pink-400 opacity-0 group-hover:opacity-100"></span>
        ...
        <a href="{{ route ('register')}}"
            ...
            <span
                class="absolute w-64 h-0 transition-all duration-300 origin-center rotate-45 -translate-x-20 bg-pink-400 top-1/2 group-hover:h-64 group-hover:-translate-y-32 ease"></span>
            <span class="relative text-pink-200 transition duration-300 group-hover:text-white ease">Sign in</span>
        </a>
    </div>
