    ...
    <div style="background-color: #f4f4f4; padding: 40px;">
        <div style="max-width: 600px; margin: auto; background: #ffffff; padding: 20px; border-radius: 8px; box-shadow: 0 4px 8px rgba(0,0,0,0.1);">
            ...
            <div style="text-align: center; margin-top: 25px; margin-bottom: 20px;">
                <a href="{{ route('getRsetPassword',$token)}}" style="font-size: 18px; font-family: Arial, sans-serif; text-decoration: none; padding: 10px 20px; color: white; background-color: rgb(255, 200, 200); border-radius: 5px; display: inline-block;">
                    Reset Password
                </a>
            </div>
