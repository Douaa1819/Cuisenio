...
<div class="max-w-6xl mx-auto mt-8 px-4">
  <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
      ...
      <article class="flex flex-col bg-white rounded-lg overflow-hidden shadow-lg my-4">
          <img class="w-full h-48 object-cover" src="https://via.placeholder.com/800x400?text=Healthy+Breakfast+Bowl" alt="Healthy Breakfast Bowl">
          <div class="p-6">
    ...
    <!-- Article 4 -->
    <article class="flex flex-col bg-white rounded-lg overflow-hidden shadow-lg my-4">
        <img class="w-full h-48 object-cover" src="https://cdn.builder.io/api/v1/image/assets/TEMP/f24f268202d77ba54bfd2fb8008dcec9a877cb3a61a63dd36e25b7d1eb4793b3?apiKey=93bb9bcd81d443648999334442ead41e&" alt="Colorful Quinoa Salad">
        <div class="p-6">
    ...
    <!-- Article 5 -->
    <article class="flex flex-col bg-white rounded-lg overflow-hidden shadow-lg my-4">
        <img class="w-full h-48 object-cover" src="https://cdn.builder.io/api/v1/image/assets/TEMP/3c176f632e531c88eb2df76c08c83c1b4cebe512f09d19017d03409bd22ee61b?apiKey=93bb9bcd81d443648999334442ead41e&" alt="Hearty Chicken Ramen Soup">
        <div class="p-6">
