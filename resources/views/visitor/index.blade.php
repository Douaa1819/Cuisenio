...
<body class="bg-[#F2F2F2] text-[#333333]">
    ...
    <div
        class="grid md:grid-cols-2 items-center md:gap-4 gap-8 font-[poppine] text-[#333] max-w-5xl max-md:max-w-md mx-auto">
        ...
        <div class="md:h-[450px]">
            <img src="{{ asset('images/visii.jpg') }}" class=" w-auto h-full md:object-contain" />
        </div>
    </div>


    <!-- Inspiration Thematic Section -->
    <section id="inspiration" class="py-20 px-6 bg-white">
        <div class="container mx-auto text-center">
            <h2 class="text-4xl font-bold mb-10">Thematic Inspiration</h2>
    ...
    <section class="py-10 px-6 bg-white">
        <div class="container mx-auto text-center">
            <h2 class="text-4xl font-bold mb-10">Check out our latest tips</h2>
            <div class="text-right">
                <button type="button" class="px-6 py-2 mb-5 mt-8 font-semibold rounded text-sm outline-none border-2 border-[#333] hover:bg-[#333] hover:text-white transition-all duration-300">View More</button>
            </div>
    ...
    <section class="flex gap-5 max-md:flex-col md:flex-nowrap">
        ...
        <div class="flex flex-col ml-5 w-[57%] max-md:ml-0 max-md:w-full">
          <img loading="lazy" src="https://cdn.builder.io/api/v1/image/assets/TEMP/df09184d82638a0ea052cf2619f572d859f8be9fc43933b95a9420b12a37d08b?apiKey=93bb9bcd81d443648999334442ead41e&" alt="Decorative image" class="grow w-full aspect-[1.19] max-md:mt-10 max-md:max-w-full" />
        </div>
      </section>
    ...
    <section class="bg-cover bg-center py-20  mt-8 text-center relative">
